    ...
    return (
        <>
            ...
            <div className="items-container row" ref={isotopeContainer}>
				...
				<div className="product-block masonry-item all cat-2 col-lg-3 col-md-6 col-sm-12">
				...
				<div className="product-block masonry-item all cat-1 cat-2 col-lg-3 col-md-6 col-sm-12">
					<div className="inner-box">
				...
				<div className="product-block masonry-item all cat-1 cat-2 cat-4 col-lg-3 col-md-6 col-sm-12">
					<div className="inner-box">
				...
				<div className="product-block masonry-item all cat-1 cat-3 col-lg-3 col-md-6 col-sm-12">
					<div className="inner-box">
				...
				<div className="product-block masonry-item all cat-1 cat-3 cat-5 col-lg-3 col-md-6 col-sm-12">
					<div className="inner-box">
				...
				<div className="product-block masonry-item all cat-2 cat-3 cat-4 col-lg-3 col-md-6 col-sm-12">
					<div className="inner-box">
				...
				<div className="product-block masonry-item all cat-1 cat-2 cat-5 col-lg-3 col-md-6 col-sm-12">
					<div className="inner-box">
				...
				<div className="product-block masonry-item all cat-1 cat-4 cat-5 col-lg-3 col-md-6 col-sm-12">
					<div className="inner-box">
