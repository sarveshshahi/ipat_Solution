                ...
                <div className="row g-5">
                    <div className="col-xl-4">
                        <div className="team__left">
                            ...
                            <Link href="/page-team" className="btn-one wow fadeInUp mt-50" data-wow-delay="200ms" data-wow-duration="1500ms" data-splitting data-text="View More">View More</Link>
                        </div>
                    </div>
