...
function Feature() {
    ...
    return (
        ...
        <section className="feature-four-area">
                ...
                <div className="row g-5 g-lg-0 align-items-end">
                    <div className="col-md-6 col-lg-4">
                        <div className="feature-four__item about__funfact">
                            <h4 className="color-light wow splt-txt mb-30" data-splitting>Our user cantered design</h4>
                            <div>
                                <ul>
                                    <li className="icon">
                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="feature-four__item item-middle">
                            <img src="assets/images/feature/feature-four-user.png" alt="image" />
                            <h4 className="title mt-30 mb-15 wow splt-txt" data-splitting>Total Number of Customers</h4>
                            <p className="text">Helps assess the correlation between customer base size and revenue
                                generation.</p>
                        </div>
                    </div>
                    <div className="col-md-6 col-lg-4">
