...
function Video() {
    ...
    return (
        ...
        <div className="video-three-area light-area">
            <div className="video-three__wrp" data-speed="0.3" data-parallax="scroll" style={{ backgroundImage: `url(assets/images/bg/video-two-bg.jpg)`}}>
