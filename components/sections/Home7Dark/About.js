...
function About() {
    ...
    return (
        ...
        <section id="about-menu" className="about-area">
            <div className="about__wrp light">
                <div className="row g-0">
                    <div className="col-lg-4">
                        <div className="about__item about__content light">
                            <div className="shape">
                                <img src="assets/images/shape/about-shape.png" alt="image" />
                            </div>
                            <h4 className="wow splt-txt" data-splitting>Our user-centred design encourages
                            ...
                            <Link href="/page-about" className="btn-two" data-splitting data-text="Learn More">Learn More</Link>
                        </div>
                    </div>
                    <div className="col-lg-4">
                        <div className="about__item about__testimonial light">
                            <div className="shape">
                                <img src="assets/images/shape/about-shape.png" alt="image" />
                            </div>
                            <div>
                                <div className="icon bg-border-dark mb-50">
                                    <svg width="24" height="22" viewBox="0 0 24 22" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <g clipPath="url(#clip0_1349_5287)">
                                            <path
                    ...
                    <div className="col-lg-4">
                        <div className="about__item about__funfact light">
                            <div className="shape">
                                <img src="assets/images/shape/about-shape.png" alt="image" />
                            </div>
                            <h4 className="wow splt-txt mb-40" data-splitting>Driving Growth Through
                                User-Centered Enhancing Productivity and Revenue</h4>
                            <div>
                                <ul>
                                    <li className="icon bg-border-dark">
