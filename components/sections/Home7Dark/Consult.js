                ...
                <div className="col-xl-6">
                    <div className="consult-left">
                        ...
                        <div className="about__item about__content light p-0">
                            ...
                            <Link href="/page-about" className="btn-one dark-mode mt-10" data-splitting data-text="Discover More">Discover More</Link>
                        </div>
                        ...
                        <div className="consult__experience-bar">
                            ...
                            <div className="image wow fadeInLeft mt-30" data-wow-delay="200ms" data-wow-duration="1500ms">
                                <img src="assets/images/consult/experience-bar-dark.png" alt="image" />
                            </div>
                        </div>
