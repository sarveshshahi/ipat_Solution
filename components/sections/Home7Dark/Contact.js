...
function Contact() {
    ...
    return (
        ...
        <section id='contact-menu' className="contact-seven-area contact-seven__dark-mode">
            <div className="container">
                <div className="contact-seven__wrp">
                    <div className="row g-0">
                        <div className="col-lg-6">
                            <div className="contact-four__form bor border-end-0 dark-area">
                        ...
                        <div className="col-lg-6">
                            <div className="contact-four__image imageLeftToRight wow light-area">
                                <img src="assets/images/contact/contact-seven-image.jpg" alt="image" />
