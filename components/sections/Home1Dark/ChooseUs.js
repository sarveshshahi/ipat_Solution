                    ...
                    <div className="choose-one__wrp">
                        <div className="section-header mb-50">
                            <h2 className="wow splt-txt" data-splitting>
                                Financial Solutions for <br /> What Your Needs
                            </h2>
                        </div>
                        ...
                        <div className="choose__tab">
                            <ul className="nav nav-tabs" role="tablist">
                                {tabs.map((tab) => (
                                    <li className="nav-item" key={tab.index} role="presentation">
                                        <button
                                            className={`nav-link ${activeIndex === tab.index ? "active" : ""}`}
                        ...
                        <div className="tab-content mt-50">
                            {activeIndex === 1 && (
                                <div className="tab-pane active">
                                    <div className="choose-one__content">
                                        <p className="mb-50">
                                            With the rapid growth of e-commerce and the significant advantages it offers, everyone is eager to establish a sales channel online. However, not everyone knows the best Solution.
                                        </p>
                                        <div className="item">
                                            <div className="icon">
                                            ...
                                            <p>
                                                We believe that the human essential to start any successful project and that this is where splendid re-generated company. Everyone is eager to establish a sales channel online.
                                            </p>
                                        </div>
                                        <div className="line" />
                                        <div className="item">
                                            ...
                                            <div>
                                                <p>
                                                    We believe that people are essential to starting any successful project, and this is where a remarkable company is reborn.
                                                </p>
                                                <ul className="mt-25">
                                                    <li>
                                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                                            xmlns="http://www.w3.org/2000/svg">
                                                            <circle cx="9" cy="9" r="9" fill="white" fillOpacity="0.1" />
                                                            <path d="M5 7.49951L7.66667 9.99951L12 6" stroke="white"
                                                                strokeWidth="1.5" />
                                                            <line x1="5" y1="12.25" x2="12" y2="12.25" stroke="white"
                                                                strokeWidth="1.5" />
                                                        </svg>
                            ...
                            {activeIndex === 2 && (
                                <div className="tab-pane active">
                                    <div className="choose-twelve__content">
                                        <p>
                                            From advanced digital technologies to the forefront of sustainable solutions, we’re always exploring new ways to deliver exceptional value...
                                        </p>
                            ...
                            {activeIndex === 3 && (
                                <div className="tab-pane active">
                                    <p>
                                        With the rapid growth of e-commerce and the significant advantages it offers, everyone is eager to establish a sales channel online...
                                    </p>
                                    <div className="work-ten__wrp">
                                        {["Ideation", "Discussion", "Testing & Initiate"].map((title, i) => (
                                            <div key={i} className="work-ten__item text-start">
                                                <div className="content">
                                                    <h4 className="title">{`0${i + 1}. ${title}`}</h4>
                                                    <p>We meet customers in set place to discuss the details about needs & demands now.</p>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                                    <Link href="/page-about" className="btn-one mt-50" data-splitting data-text="Learn More">Learn More</Link>
                                </div>
                            )}
                        </div>
                    </div>
