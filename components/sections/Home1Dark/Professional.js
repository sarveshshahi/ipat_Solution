                ...
                <div className="row g-0">
                    <div className="col-xl-6">
                        <div className="professional__image imageLeftToRight wow">
                            ...
                            <div className="content light-area">
                                <ul>
                                    <li className="icon">
                    ...
                    <div className="col-xl-6">
                        <div className="professional__content">
                            ...
                            <div>
                                ...
                                <Link href="/page-about" className="btn-one dark-mode mt-50 wow fadeInUp words chars splitting" data-wow-delay="200ms"
                                ...
                                <div className="content">
                                    ...
                                    <a onClick={() => setOpen(true)} className="item-btn video-popup">COMPANY VALUES
                                        <svg width="8"
                                            ...
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path d="M0 10.5V0L8 4.5L0 10.5Z" fill="white" />
                                        </svg>
                                    </a>
                                </div>
                            </div>
