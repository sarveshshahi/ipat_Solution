...
function About() {
    return (
        ...
        <section className="about-area light-area">
                    ...
                    <div className="col-lg-4">
                        <div className="about__item about__content">
                            <h4 className="color-light wow splt-txt" data-splitting>
                                Our user-centred design encourages productivity & boosts revenue.
                            </h4>
                            <ul>
                                {[
                            ...
                            <div>
                                <div className="icon mb-50">
                                    <svg width="24" height="22" viewBox="0 0 24 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <defs>
                                            <clipPath id="clip0_99_7624">
                                                <rect width="24" height="22" fill="white" />
                                            </clipPath>
                                        </defs>
                                    </svg>
                                </div>
                                <p>Their user-centered design approach streamlines operations and significantly boosts your productivity and revenue. From the start, they took the time to understand the best strategy.</p>
                            </div>
                    ...
                    <div className="col-lg-4">
                        <div className="about__item about__funfact">
                            <h4 className="color-light wow splt-txt mb-40" data-splitting>
                                Driving Growth Through User-Centered Enhancing Productivity and Revenue
                            </h4>
                            <div>
                                <ul>
                                    <li className="icon">
