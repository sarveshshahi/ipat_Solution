...
function Contact() {
    ...
    return (
        <section id="contact-menu" className="contact-area light-area" data-speed="0.5" data-parallax="scroll" style={{ backgroundImage: `url("assets/images/contact/contact-image.jpg")` }}>
