    ...
    return (
        ...
        <section id='home-menu' className="banner-eleven-area paralax__animation">
            ...
            <div className="banner-eleven__wrp">
                <div className="banner-eleven__content">
                    ...
                    <div className="btns mt-40 wow fadeInLeft" data-wow-delay="400ms" data-wow-duration="1500ms">
                        <Link href="/page-about" className="btn-one" data-splitting>Get Started<i className="fa-regular fs-14 fa-angle-right"></i></Link>
            ...
            <div className="banner-eleven__image">
                <img data-depth="0.03" src="assets/images/banner/banner-eleven-image.png" alt="image"  />
                <div className="info1">
                    <img className="animation__arryUpDown" src="assets/images/banner/banner-eleven-info2.png" alt="image" />
                </div>
                <div className="info2">
                    <img className="animation__arryRightLeft" src="assets/images/banner/banner-eleven-info3.png" alt="image" />
                </div>
                <div className="info3">
                    <img className="animation__arryDownUp" src="assets/images/banner/banner-eleven-info1.png" alt="image" />
                </div>
                <div className="circle">
                    <img className="animation__rotateAndScale" src="assets/images/banner/banner-eleven-circle.png" alt="image" />
                </div>
            </div>
        </section>
