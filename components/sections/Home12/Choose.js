...
function Choose() {
    ...
    return (
        ...
        <section id="about-menu" className="choose-twelve-area">
                        ...
                        <div className="tab-content mt-30" id="myTabContent">
                            <div className={activeIndex === 1 ? "tab-pane fade show active" : "tab-pane fade show"} id="home" role="tabpanel" aria-labelledby="home-tab">
                                <div className="choose-twelve__content">
                                    ...
                                    <Link href="/page-about" className="btn-one wow fadeInDown" data-wow-delay="400ms"
                            ...
                            <div className={activeIndex === 2 ? "tab-pane fade show active" : "tab-pane fade show"} id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <div className="choose-twelve__content">
                                    ...
                                    <Link href="/page-about" className="btn-one" data-splitting data-text="About Us">About Us</Link>
                                </div>
                            </div>
