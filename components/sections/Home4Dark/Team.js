...
function Team() {
    ...
    return (
        ...
        <section id="team-menu" className="team-area pt-130 pb-130">
            <div className="container">
                <div className="row g-5">
                    <div className="col-xl-4">
                        <div className="team__left">
                            <div className="section-header">
                                <h2 className="wow splt-txt" data-splitting>Bring your team together & foster a sense of unity collaboration</h2>
                            ...
                            <Link href="/page-team" className="btn-one dark-mode wow fadeInUp mt-50" data-wow-delay="200ms" data-wow-duration="1500ms" data-splitting data-text="View More">View More</Link>
                        </div>
                    </div>
