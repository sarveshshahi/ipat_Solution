...
function Services() {
    ...
    return (
        ...
        <section id="service-menu" className="service-four-aera pt-130 pb-130">
            <div className="container">
                ...
                <div className="row g-5">
                    <div className="col-md-6 col-xxl-3 wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div className="service-four__item dark-mode">
                            <div className="content">
                                ...
                                <h4 className="title"><Link href="/page-service-details">Business Strategy and Planning</Link></h4>
                            </div>
                            <div className="image">
                    ...
                    <div className="col-md-6 col-xxl-3 wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div className="service-four__item dark-mode">
                            <div className="content">
                                <div className="icon-wrp">
                                    <div className="icon">
                                        <svg width="14" height="24" viewBox="0 0 14 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <g clipPath="url(#clip0_1095_37207)">
                                                <path
                                ...
                                <h4 className="title"><Link href="/page-service-details">International Business Consulting</Link></h4>
                            </div>
                            <div className="image">
                    ...
                    <div className="col-md-6 col-xxl-3 wow fadeInLeft" data-wow-delay="400ms" data-wow-duration="1500ms">
                        <div className="service-four__item dark-mode">
                            <div className="content">
                                <div className="icon-wrp">
                                    <div className="icon">
                                ...
                                <h4 className="title"><Link href="/page-service-details">E-Commerce and Market</Link></h4>
                            </div>
                            <div className="image">
                    ...
                    <div className="col-md-6 col-xxl-3 wow fadeInLeft" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div className="service-four__item dark-mode">
                            <div className="content">
                                <div className="icon-wrp">
                                    <div className="icon">
                                ...
                                <h4 className="title"><Link href="/page-service-details">Human Resources and Management</Link></h4>
                            </div>
                            <div className="image">
