        ...
        <section className="testimonial-ten-aera">
            <div className="row g-0">
                ...
                <div className="col-xl-8">
                    <div className="testimonial-ten-right" style={{ backgroundImage: `url(assets/images/bg/testimonial-ten-bg-dark.jpg)`}}>
                                ...
                                <SwiperSlide className="swiper-slide">
                                    <div className="testimonial-ten__item">
                                        ...
                                        <div className="info">
                                            ...
                                            <img src="assets/images/testimonial/testimonial-ten-info-dark.png" alt="image" />
                                        </div>
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide className="swiper-slide">
