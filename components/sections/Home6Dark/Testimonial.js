...
function Testimonial() {
    return (
        ...
        <section className="testimonial-area bg-sub pt-130 pb-130">
            <div className="testimonial-six__image animation__arryLeftRight">
                <img className="wow bounceInRight" src="assets/images/testimonial/testimonial-six-image.png" alt="image" />
                <div className="sign">
                    <img className="animation__arryUpDown" src="assets/images/testimonial/sing.png" alt="sign-image" />
                </div>
            </div>
                            ...
                            <div className="swiper testimonial__slider">
                                <Swiper {...swiperOptions} className="swiper-wrapper">
                                    <SwiperSlide className="swiper-slide">
                                        <div className="testimonial__item dark-mode">
                                            <div className="icon">
