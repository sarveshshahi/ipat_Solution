        ...
        <section className="testimonial-three-area pt-130 pb-130">
            <div className="container">
                ...
                <div className="testimonial-three__wrp">
                    ...
                    <button className="testimonial-three__arry-prev dark-mode"><i className="fa-light fa-chevron-left"></i></button>
                    <button className="testimonial-three__arry-next dark-mode"><i className="fa-light fa-chevron-right"></i></button>
                </div>
            </div>
        </section>
    );
