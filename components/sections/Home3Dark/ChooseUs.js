    ...
    return (
        ...
        <section className="choose-three-area">
            <div className="section-header text-center mb-60">
                <h2 className="wow splt-txt text-white" data-splitting>We officially adhere to an international <br /> Business strategy.</h2>
            </div>
            <div className="container">
                <div className="choose-three__tab mb-50">
                    <ul className="nav nav-tabs" id="myTab" role="tablist">
                        <li className="nav-item" role="presentation">
                            <button className={activeIndex === 1 ? "nav-link active text-white" : "nav-link text-white"} onClick={() => handleOnClick(1)} id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">Why Choose Us</button>
                        </li>
                        <li className="nav-item" role="presentation">
                            <button  className={activeIndex === 2 ? "nav-link active text-white" : "nav-link text-white"} onClick={() => handleOnClick(2)} id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">Promise of Excellence</button>
                        </li>
                        <li className="nav-item" role="presentation">
                            <button  className={activeIndex === 3 ? "nav-link active text-white" : "nav-link text-white"} onClick={() => handleOnClick(3)} id="messages-tab" data-bs-toggle="tab" data-bs-target="#messages" type="button" role="tab" aria-controls="messages" aria-selected="false">Why Need Consultation?</button>
                        </li>
                        <li className="nav-item" role="presentation">
                            <button  className={activeIndex === 4 ? "nav-link active text-white" : "nav-link text-white"} onClick={() => handleOnClick(4)} id="settings-tab" data-bs-toggle="tab" data-bs-target="#settings" type="button" role="tab" aria-controls="settings" aria-selected="false">How it Works</button>
                        </li>
                    </ul>
                </div>
            </div>
                                    ...
                                    <div className="row g-4">
                                        <div className="col-md-6 col-xl-4 wow fadeInLeft" data-wow-delay="00ms"
                                            ...
                                            <div className="solution__item">
                                                ...
                                                <div className="content">
                                                    <h5 className="sub-title text-white">Start up Business</h5>
                                                    <div className="title">
                                        ...
                                        <div className="col-md-6 col-xl-4 wow fadeInLeft" data-wow-delay="200ms"
                                            ...
                                            <div className="solution__item">
                                                ...
                                                <div className="content">
                                                    <h5 className="sub-title text-white">Small Business</h5>
                                                    <div className="title">
                                        ...
                                        <div className="col-md-6 col-xl-4 wow fadeInLeft" data-wow-delay="400ms"
                                            ...
                                            <div className="solution__item">
                                                ...
                                                <div className="content">
                                                    <h5 className="sub-title text-white">Entrepreneur</h5>
                                                    <div className="title">
