...
function Testimonial() {
    ...
    return (
        ...
        <section className="testimonial-nine-area pt-130 pb-130">
            <div className="container">
                <div className="testimonial-nine__wrp">
                    <div className="row g-5 align-items-center">
                        <div className="col-lg-6">
                            <div className="testimonial-nine-right">
                                <div className="section-header pb-50 mb-50">
                                    <h6>Our Testimonials</h6>
                                    <h2 className="wow splt-txt" data-splitting>1250+ People Say About
                                        Our Tech Services</h2>
                                </div>
                                <div className="swiper testimonial-five__slider">
                                    <Swiper {...swiperOptions} className="swiper-wrapper">
                                        <SwiperSlide className="swiper-slide">
                                            <div className="testimonial-nine__item">
                                                <h4 className="title">
                                ...
                                <div className="mt-50">
                                    <div className="swiper__dots testimonial__dot"></div>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6">
                            <div className="testimonial-nine__image">
                                <img src="assets/images/testimonial/testimonial-nine-image.jpg" alt="image" />
                            </div>
                        </div>
                    </div>
                </div>
