...
function Testimonial() {
    ...
    return (
        ...
        <section className="testimonial-thirteen-area light-area pt-130 pb-130">
            <div className="container">
                <div className="testimonial-thirteen__wrp">
                    <div className="row g-0 g-lg-5 align-items-center">
                        <div className="col-lg-6">
                            <div className="testimonial-thirteen__image">
                                <img src="assets/images/testimonial/testimonial-thirteen-image.jpg" alt="image" />
                            </div>
                        </div>
                        <div className="col-lg-6">
                            <div className="testimonial-thirteen-right">
                                <div className="section-header pb-50 mb-50">
                                    <h6 className="text-white">Our Testimonials</h6>
                                    <h2 className="wow splt-txt text-white" data-splitting>1250+ People Say About
                                        Our Tech Services</h2>
                                </div>
                                <div className="swiper testimonial-five__slider">
                                    <Swiper {...swiperOptions} className="swiper-wrapper">
                                        <SwiperSlide className="swiper-slide">
                                            <div className="testimonial-thirteen__item">
                                                <h4 className="title">
                                                ...
                                                <p className="text">Climb the mountain not to plant your flag but to embrace
                                                    the ways challenge, enjoy the air, and behold the. Climb it
                                                    see the world, not so the world can see you.</p>
                                                <div className="ratting">
                                                    <img src="assets/images/icon/testi-logo-light.png" alt="icon" />
                                        ...
                                        <SwiperSlide className="swiper-slide">
                                            <div className="testimonial-thirteen__item">
                                                <h4 className="title">
                                                    ...
                                                    Leslie Alexander / <span>CEO & Founder</span>
                                                </h4>
                                                <p className="text">Climb the mountain not to plant your flag but to embrace
                                                    the ways challenge, enjoy the air, and behold the. Climb it
                                                    see the world, not so the world can see you.</p>
                                        ...
                                        <SwiperSlide className="swiper-slide">
                                            <div className="testimonial-thirteen__item">
                                                <h4 className="title">
                                                    ...
                                                    Arlene McCoy / <span>Co-Ordinator</span>
                                                </h4>
                                                <p className="text">Climb the mountain not to plant your flag but to embrace
                                                    the ways challenge, enjoy the air, and behold the. Climb it
                                                    see the world, not so the world can see you.</p>
