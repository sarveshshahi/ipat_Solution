...
function Solution() {    
    return (
        ...
        <section className="solution-area light-area pt-130 pb-130" style={{ backgroundImage: `url(assets/images/bg/solution-bg-image.jpg)`}} >
                            ...
                            <div className="solution__item">
                                ...
                                <div className="content">
                                    ...
                                    <div className="title">
                                        ...
                                        <h4 className="text-white"><Link href="/">Defense Arsenal Unveiling Our Cyber Security Suite</Link></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="solution__item">
                                ...
                                <div className="content">
                                    ...
                                    <div className="title">
                                        ...
                                        <h4 className="text-white"><Link href="/">Fortified Protection Explore Our Robust Security Features</Link></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="solution__item">
                                ...
                                <div className="content">
                                    ...
                                    <div className="title">
                                        ...
                                        <h4 className="text-white"><Link href="/">Empowering Digital Safety at Every Level Protection</Link></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
