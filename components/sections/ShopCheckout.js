              		...
              		<form id="checkout-form" action="#">
              			<div className="row mt-30">
                  			...
                  			<div className="col-md-6">
                  				...
                  				<textarea id="order_comments" className="form-control" placeholder="Notes about your order, e.g. special notes for delivery." rows="9"></textarea>
                  			</div>
                  			<div className="col-md-12 mt-30">
                  				...
                  				<table className="table table-striped table-bordered tbl-shopping-cart">
									...
									<tbody>
										<tr>
											<td className="product-thumbnail"><Link href="/shop-product-details"><img alt="product" src="assets/images/resource/products/1.jpg" /></Link></td>
											<td className="product-name"><Link href="/shop-product-details">Headphone</Link> x 2</td>
											<td><span className="amount">$36.00</span></td>
										</tr>
										<tr>
											<td className="product-thumbnail"><Link href="/shop-product-details"><img alt="product" src="assets/images/resource/products/2.jpg" /></Link></td>
											<td className="product-name"><Link href="/shop-product-details">Lagage</Link> x 3</td>
											<td><span className="amount">$115.00</span></td>
										</tr>
										<tr>
											<td className="product-thumbnail"><Link href="/shop-product-details"><img alt="product" src="assets/images/resource/products/3.jpg" /></Link></td>
                  								...
                  								<div className="payment-info">
                  									<div className="row clearfix">
                  										...
                  										<div className="col-lg-6 col-md-12 col-sm-12 column">
															  ...
															  <button type="submit" className="theme-btn btn-one" data-loading-text="Please wait...">Make Payment</button>
                  											</div>
                  										</div>
                  									</div>
                  								</div>
