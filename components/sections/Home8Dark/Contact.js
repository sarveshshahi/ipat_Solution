...
function Contact() {
    ...
    return (
        ...
        <section id="contact-menu" className="contact-four-area mt-130">
                    ...
                    <div className="row g-0">
                        <div className="col-lg-6">
                            <div className="contact-four__form">
                                ...
                                <form onSubmit={handleSubmit(onSubmit)}>
                                    ...
                                    <button type="submit" className="btn-one dark-mode rounded-0 w-100" data-splitting disabled={loading}>
                        ...
                        <div className="col-lg-6">
                            <div className="contact-four__image imageLeftToRight wow light-area">
                                <img src="assets/images/contact/contact-eight-image.jpg" alt="image" />
                            ...
                            <Swiper {...swiperOptions} className="swiper-wrapper">
                                <SwiperSlide className="swiper-slide">
                                    <div className="brand-two__item">
                                        <Link href="/"><img src="assets/images/brand/contact-brand1.png" alt="image" /></Link>
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide className="swiper-slide">
                                    <div className="brand-two__item">
                                        <Link href="/"><img src="assets/images/brand/contact-brand2.png" alt="image" /></Link>
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide className="swiper-slide">
                                    <div className="brand-two__item">
                                        <Link href="/"><img src="assets/images/brand/contact-brand3.png" alt="image" /></Link>
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide className="swiper-slide">
                                    <div className="brand-two__item">
                                        <Link href="/"><img src="assets/images/brand/contact-brand4.png" alt="image" /></Link>
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide className="swiper-slide">
                                    <div className="brand-two__item">
                                        <Link href="/"><img src="assets/images/brand/contact-brand5.png" alt="image" /></Link>
                                    </div>
                                </SwiperSlide>
                                <SwiperSlide className="swiper-slide">
                                    <div className="brand-two__item">
