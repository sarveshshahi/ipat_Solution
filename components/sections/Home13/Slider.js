...
function Slider() {
    return (
        ...
        <section id='home-menu' className="banner-thirteen-area paralax__animation" style={{ backgroundImage: `url(assets/images/banner/banner-thirteen-bg.jpg)`}}>
            ...
            <div className="banner-thirteen__image">
                ...
                <div data-depth="0.03" className="info1">
                    <img src="assets/images/banner/banner-thirteen-info1.png" alt="image" />
                    <div className="arry">
                ...
                <div data-depth="0.05" className="info2">
                    <img src="assets/images/banner/banner-thirteen-info2.png" alt="image" />
                </div>
            </div>
