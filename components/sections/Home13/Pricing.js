...
function Pricing() {
    ...
    return (
        ...
        <section className="pricing-area pt-130 pb-130">
            <div className="container">
                <div className="pricing__wrp">
                    ...
                    <div className="row g-4">
                        <div className="col-md-6 col-xxl-4 wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                        ...
                        <div className="col-md-6 col-xxl-4 wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                        ...
                        <div className="col-md-6 col-xxl-4 wow fadeInLeft" data-wow-delay="400ms" data-wow-duration="1500ms">
                            <div className="pricing__item">
                                <div className="title">
                                    <h6>premium plan</h6>
                                </div>
