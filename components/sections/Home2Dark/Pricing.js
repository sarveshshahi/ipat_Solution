...
function Pricing() {
    ...
    return (
        <>
            ...
            <section className="pricing-area pb-130">
                    ...
                    <div className="pricing__wrp">
                        ...
                        <div className="row g-4">
                            <div className="col-lg-6 col-xxl-4 wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">
                                <div className="pricing__item dark-mode popular">
                                    <div className="light-area">
                                        ...
                                        <p className="mb-30">Manage and streamline operations acr osers multiple locations
                                            wenels
                                        </p>
                                        <Link href="/contact" className="btn-one mb-20 w-100 rounded-0" data-splitting
                                            data-text="Get Started With Plan">Get
                                            Started With Plan</Link>
                            ...
                            <div className="col-lg-6 col-xxl-4 wow fadeInLeft" data-wow-delay="200ms"
                                ...
                                <div className="pricing__item dark-mode light-area popular popular-dark">
                                    ...
                                    <p className="mb-30">Manage and streamline operations acr osers multiple locations wenels
                                    </p>
                                    <Link href="/contact" className="btn-one-light mb-20 w-100 rounded-0" data-splitting
                                        data-text="Get Started With Plan">Get
                                        Started With Plan</Link>
