                    ...
                    <div className="row g-4 g-xl-0 align-items-center">
                        <div className="col-xl-6 order-2 order-xl-1">
                            <div className="contact-two-left">
                                ...
                                <div class="contact-two__form dark-mode">
                        ...
                        <div className="col-xl-6 order-1 order-xl-2">
                            <div className="contact-two__map">
                                <img src="assets/images/contact/map-dark.png" alt="image" />
                                <div className="location">
                                    <img className="wow bounceIn" src="assets/images/contact/map-location-dark.png" alt="image" />
                                </div>
                            </div>
                        </div>
                    </div>
