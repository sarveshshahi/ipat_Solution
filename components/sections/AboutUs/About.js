                ...
                <div className="row g-5">
                    <div className="col-lg-6">
                        <div className="about__image">
                            ...
                            <div className="text-shape wow fadeInUp" data-wow-delay="400ms" data-wow-duration="1500ms">
                                <img className="animation__rotateY" src="assets/images/about/about-circle-text.png" alt="text" />
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-6">
                        <div className="section-header">
                            ...
                            <h2 className="wow splt-txt" data-splitting>Have a project? Let’s <br /> Discuss it</h2>
                            <p className="wow fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">fusce accumsan tincidunt erat et convallis risus ullamcorper euoled <br /> vehicula massa a massa cursus</p>
                        </div>
                        ...
                        <div className="image mt-60">
                            <figure className="wow">
                                <img src="assets/images/about/about-image2.jpg" alt="image" />
                            </figure>
                        </div>
                    </div>
                </div>
