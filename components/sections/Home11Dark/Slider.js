...
function Slider() {
    return (
        ...
        <section id='home-menu' className="banner-eleven-area paralax__animation">
            <div className="banner-eleven__shape">
                <img src="assets/images/banner/banner-eleven-shape.png" alt="image" />
            </div>
            <div className="banner-eleven__wrp">
                <div className="banner-eleven__content">
                    <h5 className="text-uppercase wow fadeInLeft" data-wow-delay="00ms" data-wow-duration="1500ms">Welcome
                        to Stratify</h5>
                    <h1 className="title wow splt-txt" data-splitting>Elevate Your Brand with Proven Marketing
                        Expertise!</h1>
                    <p className="text wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">We bring a fresh,
                        dynamic perspective to every client relationship, fuelled by a
                        relentless energy that drives results.</p>
                    <div className="btns mt-40 wow fadeInLeft" data-wow-delay="400ms" data-wow-duration="1500ms">
                        <Link href="/page-about" className="btn-one dark-mode" data-splitting>Get Started<i className="fa-regular fs-14 fa-angle-right"></i></Link>
                        <div className="d-flex gap-2 align-items-center" data-depth="0.03">
                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g clipPath="url(#clip0_1349_1990)">
                                    <path
                                        ...
                                        fill="white" />
                                    <path
                                        d="M16.2124 7.13611C17.8713 7.4147 19.3782 8.19983 20.5813 9.40286C21.7843 10.6059 22.5631 12.1128 22.848 13.7717C22.9177 14.1896 23.2786 14.4809 23.6901 14.4809C23.7408 14.4809 23.7851 14.4746 23.8358 14.4682C24.3043 14.3922 24.6146 13.949 24.5386 13.4805C24.1967 11.4733 23.2469 9.64346 21.7969 8.1935C20.347 6.74354 18.5171 5.79379 16.51 5.45187C16.0414 5.37589 15.6045 5.68615 15.5222 6.14836C15.4399 6.61058 15.7438 7.06013 16.2124 7.13611Z"
                                        fill="white" />
                                    <path
                                        d="M29.9644 13.2336C29.4009 9.92848 27.8433 6.92092 25.4499 4.52754C23.0565 2.13415 20.049 0.576553 16.7438 0.0130316C16.2816 -0.0692806 15.8447 0.247305 15.7624 0.709519C15.6864 1.17807 15.9967 1.61495 16.4652 1.69727C19.4158 2.19747 22.1068 3.59678 24.2469 5.73056C26.387 7.87068 27.78 10.5617 28.2802 13.5122C28.3498 13.9301 28.7108 14.2214 29.1223 14.2214C29.173 14.2214 29.2173 14.215 29.2679 14.2087C29.7302 14.1391 30.0467 13.6958 29.9644 13.2336Z"
                                        fill="white" />
                                </g>
                                <defs>
                                    <clipPath id="clip0_1349_1990">
                                        <rect width="30" height="30" fill="white" />
                                    </clipPath>
                                </defs>
                            </svg>
                            <div>
                                <span className="fs-14">Got Questions?</span>
                                <h4>000 2222 0000</h4>
                            </div>
                        </div>
                    </div>
            ...
            <div className="banner-eleven__image">
                <img data-depth="0.03" src="assets/images/banner/banner-eleven-image-dark.png" alt="image"  />
                <div className="info1">
                    <img className="animation__arryUpDown" src="assets/images/banner/banner-eleven-info2-dark.png" alt="image" />
                </div>
                <div className="info2">
                    <img className="animation__arryRightLeft" src="assets/images/banner/banner-eleven-info3-dark.png" alt="image" />
                </div>
                <div className="info3">
                    <img className="animation__arryDownUp" src="assets/images/banner/banner-eleven-info1-dark.png" alt="image" />
                </div>
                <div className="circle">
                    <img className="animation__rotateAndScale" src="assets/images/banner/banner-eleven-circle-dark.png" alt="image" />
                </div>
            </div>
        </section>
