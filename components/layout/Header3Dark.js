...
const Header3Dark = ({ scroll }) => {
    ...
    return (
        <>
            ...
            <div className="header-top-area light-area d-none d-lg-block">
            ...
            <header className={`header-area dark-area header-three-area ${scroll ? "menu-fixed" : ""}`}>
                <div className="container">
                    <div className="header__main">
                        ...
                        <div className="main-menu">
                            ...
                            <div className="menu-btns">
                                ...
                                <button className="menubars" type="button" data-bs-toggle="offcanvas" data-bs-target="#menubar" onClick={handleToggleSidebar}>
                                    <span></span>
                                    <span></span>
                                    <span></span>
                                </button>
