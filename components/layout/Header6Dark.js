...
const Header6Dark = ({ scroll }) => {
    ...
    return (
        <>
            <header className={`header-area light-area header-dark-area ${scroll ? "menu-fixed" : ""}`}>
                <div className="container">
                    <div className="header__main">
                        ...
                        <div className="main-menu main-menu-light">
                            ...
                            <div className="menu-btns light header-twelve__btns">
                                <Link href="/contact" className="btn-two-light rounded-0" data-splitting>Free Consultant <i className="fa-regular fa-arrow-right" /></Link>
            ...
            <div className={`sidebar-area light-area offcanvas offcanvas-end ${sidebarToggle ? "show" : ""}`} id="menubar">
