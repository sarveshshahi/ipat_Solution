            ...
            <header className={`header-area header-blur ${scroll ? "menu-fixed" : ""}`}>
                <div className="container">
                    <div className="header__main">
                        <Link href="/" className="logo logo-main"><img src="assets/images/logo/logo.png" alt="logo" /></Link>
                        <Link href="/" className="logo logo-light"><img src="assets/images/logo/logo-light.png" alt="logo" /></Link>
