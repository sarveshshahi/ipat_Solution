...
const Footer7 = () => {
    return (
        ...
        <footer className="footer-eleven-area light-area bg-sub-dark">
                ...
                <div className="container">
                    <div className="wrp">
                        ...
                        <ul className="footer-info">
                            <li><Link href="/"><svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                    ...
                    <div className="row g-5">
                        <div className="col-lg-5">
                            <div className="footer-eleven-left">
                                ...
                                <div className="input">
                                    <input type="text" placeholder="your e-amil" />
                                    <button>Send<i className="fa-thin fa-arrow-up-right"></i></button>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-7">
                            <div className="footer-eleven-righ mb-60">
                                <h4 className="text-white mb-60">Professional & modern, a theme designed to help <br /> your
                                    business
                                    stand out
                                    from
                                    the seat.
