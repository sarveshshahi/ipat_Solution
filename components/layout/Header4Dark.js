...
const Header4Dark = ({ scroll }) => {
    ...
    return (
        <>
            ...
            <div className="header-top-area light-area fixed d-none d-lg-block">
            ...
            <header className={`header-area light-area header-four-area ${scroll ? "menu-fixed" : ""}`}>
                <div className="container">
