...
const Header5Single = ({ scroll }) => {
    ...
    return (
        <>
            ...
            <header className={`header-area header-eight-area ${scroll ? "menu-fixed" : ""}`}>
                <div className="header__main">
                    ...
                    <div className="menu-btns header-eight__btns">
                        <div className="call">
                            <div className="icon">
                                <svg className="ring__animation" width="16" height="16" viewBox="0 0 16 16" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_1349_4424)">
                                        <path
                        ...
                        <Link href="/contact" className="header-btn">Get in Touch <i className="fa-light fa-arrow-up-right" /></Link>
                    </div>
                </div>
            </header>
