...
import NavLinks from './NavLinks4';
import MobileMenu from './MobileMenu';

const Header7Dark = ({ scroll }) => {
    ...
    return (
        <>
            ...
            <div className="header-top-area light d-none d-lg-block">
            ...
            <header className={`header-area header-three-area ${scroll ? "menu-fixed" : ""}`}>
                <div className="container">
                    <div className="header__main header-nine__main">
